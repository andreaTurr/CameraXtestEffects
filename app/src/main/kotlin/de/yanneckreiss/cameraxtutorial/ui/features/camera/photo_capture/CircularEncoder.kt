...
import de.yanneckreiss.cameraxtutorial.ui.features.camera.photo_capture.CircularEncoder.EncoderThread.EncoderHandler
import java.io.File
...
class CircularEncoder(
    ...
    fun shutdown() {
        ...
        val handler: EncoderHandler? = mEncoderThread.handler
    ...
    fun saveVideo(outputFile: File?) {
        ...
        handler?.sendMessage(
            handler.obtainMessage(
                EncoderHandler.MSG_SAVE_VIDEO, outputFile
            )
        )
    }
    ...
    private class EncoderThread(
        private val mEncoder: MediaCodec, private val mEncBuffer: CircularEncoderBuffer,
    ...
    companion object {
        private val TAG = CircularEncoder::class.java.simpleName
